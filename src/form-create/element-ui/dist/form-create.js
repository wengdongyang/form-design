/*!
 * @form-create/element-ui v2.5.37
 * (c) 2018-2024 xaboy
...
(function (global, factory) {
  ...
  var Checkbox = {
    ...
    render: function render() {
      ...
      return h("ElCheckboxGroup", helper([{}, this.formCreateInject.prop, {}, {
        ...
        var Type = _this.type === 'button' ? 'ElCheckboxButton' : 'ElCheckbox';
        delete props.value;
  ...
  var Select = {
    ...
    render: function render(h, ctx) {
      ...
      return h("ElSelect", helper([{}, ctx.data, {
        "ref": "el"
  ...
  var Upload = {
    ...
    render: function render() {
      ...
      return h("div", {
        "class": '_fc-upload'
      }, [[this.formCreateInject.prop.props.showFileList ? [] : this.makeFiles(), this.makeUpload()], h("el-dialog", helper([{}, {
        "props": {
          appendToBody: true,
          modal: this.previewMask,
  ...
  var css_248z$3 = ".form-create .form-create .el-form-item {\n    margin-bottom: 22px;\n}\n\n.form-create .form-create .el-form-item .el-form-item {\n    margin-bottom: 0px;\n}\n";
